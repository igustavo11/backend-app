...
const ListOrdersControllers_1 = require("./controllers/order/ListOrdersControllers");
...
router.post('/produtos', isAuthenticated_1.isAuthenticated, new CreateProductController_1.CreateProductController().handle);
router.get('/category/produtos', isAuthenticated_1.isAuthenticated, new ListByCategoryController_1.ListByCategoryController().handle);
//rotas orders
...
router.get('/orderstotal', isAuthenticated_1.isAuthenticated, new ListOrdersControllers_1.ListOrdersControllers().handle);
